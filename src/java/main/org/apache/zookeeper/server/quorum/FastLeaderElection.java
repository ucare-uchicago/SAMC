...
public class FastLeaderElection implements Election {
     ...
     * leader election.
     */
    final static int finalizeWait = Integer.parseInt(ZKAspectProperties.getConfig("finalize_wait"));;
//    final static int finalizeWait = 200;
    ...
    public Vote lookForLeader() throws InterruptedException {
        ...
        int notTimeout = Integer.parseInt(ZKAspectProperties.getConfig("noti_timeout"));
